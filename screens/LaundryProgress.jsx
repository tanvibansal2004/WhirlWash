...
//               const bookingTime = bookingData.bookingTime ? bookingData.bookingTime.toDate() : new Date();
//               const now = new Date();
...
//     return () => unsubscribe();
//   }, [currentUser, navigation, progressAnimation]);
...
// // Need to define Svg components separately
